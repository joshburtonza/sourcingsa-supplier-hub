  ...
  return (
    <div className="relative grid min-h-screen place-items-center px-4 py-10">
      <div aria-hidden className="pointer-events-none absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 50% 40% at 50% 50%, var(--glow) 0%, transparent 70%)",
        }} />
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            <Field label="Email">
              <input required type="email" autoComplete="email"
                ...
                className="input focus-glow" placeholder="you@example.com" />
            </Field>
            <Field label="Password">
              <div className="relative">
                <input required type={showPw ? "text" : "password"}
                  ...
                  className="input focus-glow pr-11" placeholder="••••••••" />
